...
then
  ...
  curl \
    "https://api.github.com/repos/geekhomeinside/oneforall/milestones/$milestone_id" \
...
git config --global user.email "guiadco@geekhomeinside.com"
git config --global user.name "GeekHomeInside Bot"
